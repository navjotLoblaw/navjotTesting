var DepartureBoard = function (element, options) {
	...
	var rowCount = options.rowCount || 10,
		letterCount = options.letterCount || 34,
		letter,
		rowElement;
...
DepartureBoard.LETTERS = " 0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ.,':()&!?+-_";
...
DepartureBoard.Letter.prototype.spin = function (clear) {
	...
	var me = this;
	this._interval = window.setInterval (function () { me._tick (); }, DepartureBoard.Letter.DROP_TIME * 1.4);
};
